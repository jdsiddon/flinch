...
var data = {
	...
	/* Convert .txt file to Mongoose Object and save to DB.
		 ...
		 in format, start time, sensitivity (g's), rate (hz), and if the shot was from
		 a hand or rest. */
	...
	log: function(data, cb) {
		...
		var testArray = [];
		var sampleSize = 200;																	 // Number of data points collected (length of array on arduino).
